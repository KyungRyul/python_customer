...
def write(custlist):
    with open('customeList3.txt', 'wb') as f:
        pickle.dump(custlist, f)

def search():
    with open('/workspaces/vscode-remote-try-python/customeList2.txt', 'rb') as f:
        data = pickle.load(f)
        print(data)