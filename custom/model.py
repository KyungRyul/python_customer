...
class model:
    ...
    def write(self, custlist):
        fname = input('파일이름을 입력 하시오.')
        with open(fname, 'wb') as f:
            pickle.dump(custlist, f)
    def fupdate(self, custlist):
        fname = input('파일이름을 입력 하시오.')
